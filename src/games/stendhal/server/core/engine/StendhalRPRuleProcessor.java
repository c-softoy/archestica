/* $Id: StendhalRPRuleProcessor.java,v 1.97 2013/10/05 19:06:00 nhnb Exp $ */
/***************************************************************************
...
public class StendhalRPRuleProcessor implements IRPRuleProcessor {
	...
	private static String welcomeMessage = "Welcome to Archestica! Need help? #http://archestica.net/ask_for_help - please report problems, suggestions and bugs. Remember to keep your password completely secret, never tell to another friend, player, or admin.";
